...
#1.975309*(c(5,10,15,20)*(9+9*4))^2
	if (WHICH_CDAT == "ST" || WHICH_CDAT == "WT") {
		if (THE_L == 5) {       Niter <- 1*60000;  thin <- Niter/10000; step_e <- 0.10; step_L <- 25; }
		else if (THE_L == 10) { Niter <- 1*210000;  thin <- Niter/10000; step_e <- 0.04; step_L <- 5; }
		else if (THE_L == 15) { Niter <- 1*500000;  thin <- Niter/10000; step_e <- 0.005; step_L <- 5; }
		else if (THE_L == 20) { Niter <- 1*810000; thin <- Niter/10000; step_e <- 0.001; step_L <- 10; }
